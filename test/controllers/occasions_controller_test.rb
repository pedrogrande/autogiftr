...
class OccasionsControllerTest < ActionController::TestCase
  ...
  test "should create occasion" do
    assert_difference('Occasion.count') do
      post :create, occasion: { date: @occasion.date, recipient_id: @occasion.recipient_id, title: @occasion.title }
    end
  ...
  test "should update occasion" do
    patch :update, id: @occasion, occasion: { date: @occasion.date, recipient_id: @occasion.recipient_id, title: @occasion.title }
    assert_redirected_to occasion_path(assigns(:occasion))
  end
